...
Consulta para traer ciudades de provincia
select a.City from cities as a join regions as b on b.RegionID = a.RegionID where b.Region like '%buenos%';
...
/* ---------------- */
/*COMENTO LAS BASES PAIS Y CIUDAD PARA PROBAR IMPORTAR LA OTRA BASE*/
/*
