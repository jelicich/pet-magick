...
CREATE TABLE users(
	...
	RANGO TINYINT(1) UNSIGNED NOT NULL, /* Aca probe de todo y solo funciono cuando cambie RANGE x RANGO. Parece ser q el problema es el nombre, raro... */
...
CREATE TABLE tributes(
	...
	BREED VARCHAR(45),
	SINCE DATE NOT NULL,
	HASTA DATE NOT NULL, /* Aca probe de todo y solo funciono cuando cambie TO x HASTA. Parece ser q el problema es el nombre, raro... */
	PIC CHAR(30), 
	USER_ID INT UNSIGNED NOT NULL,
	PET_ID INT UNSIGNED, 
