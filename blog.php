...
<div id="wrapper">
	...
	<div class="mod grid_12 org-mod nogrid-mod" id='featured-blog'>
		<?php 
	...
	<!-- Current projects module -->
		<?php 
			include_once 'templates/blogListModule.php'; 
		?>
...
<script type="text/javascript">
	selectedFromList('featured-blog', 'ajax/getSelectedBlog.php?p=');
</script>
